...
//						Schema.createField(DataType.STRING, "InsertSchema"),
	...
	public void processTuple(int inputPort, Tuple tuple) throws StreamBaseException {
		...
		if (cmd.equals("insert")) {
			...
			generateAndRespond(ID, Collection, Document.parse(tuple.getString("Data")), null);
			...
			try (MongoCursor<Document> cursor = retIter.iterator()) {
				while (cursor.hasNext()) {
					generateAndRespond(ID, Collection, cursor.next(), null);
				}
			} catch (Exception e) {
				// TODO Auto-generated catch block
				generateAndRespond(ID, Collection, ret, e);
				e.printStackTrace();
			}
			...
			try {
				...
				generateAndRespond(ID, Collection, ret, null);
			} catch (Exception e) {
				// TODO Auto-generated catch block
				generateAndRespond(ID, Collection, ret, e);
				e.printStackTrace();
